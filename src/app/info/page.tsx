...
const content = {
  title: { de: 'Information', en: 'Information', fr: 'Informations' },
  ...
  accessibilityTitle: { de: 'Besucherhinweis', en: 'Visitor Notice', fr: 'Avis aux visiteurs' },
  accessibilityText: {
    ...
    fr: 'Veuillez vous comporter de manière respectueuse. Les chiens doivent être tenus en laisse. Merci de contribuer à la préservation de ce site historique.',
  },
  dailyOpen: {
  ...
  routePlan: { de: 'Route planen', en: 'Plan route', fr: 'Planifier l\'itinéraire' },
}

const openingHours = [
  { season: { de: 'Winter (Nov - Feb)', en: 'Winter (Nov - Feb)', fr: 'Hiver (Nov - Fév)' }, time: '08:00 – 16:00' },
  { season: { de: 'Frühjahr (März - April)', en: 'Spring (Mar - Apr)', fr: 'Printemps (Mars - Avr)' }, time: '08:00 – 18:00' },
  { season: { de: 'Sommer (Mai - Aug)', en: 'Summer (May - Aug)', fr: 'Été (Mai - Août)' }, time: '08:00 – 20:00' },
  { season: { de: 'Herbst (Sept - Okt)', en: 'Autumn (Sep - Oct)', fr: 'Automne (Sep - Oct)' }, time: '08:00 – 18:00' },
]
